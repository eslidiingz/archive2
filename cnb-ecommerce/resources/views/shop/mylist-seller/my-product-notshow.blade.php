...
<div class="col-12 px-0">
    <table class="table-bordered">
        ...
        <tbody>
            @foreach($products->whereIn('status_goods',[2]) as $key=>$product)
                        ...
                        <div class="col-12 mb-2 text-lg-left text-md-right text-sm-right">
                            ...
                            if($value <= 0){ $chk_price=true;}} @endphp @if($chk_stock> 0 && $chk_price == false)
                                <div
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="switch_not{{$product->id}}"
                                        onclick="send_status_goods3({{$product->id}})"
                                        style="background-color:#333;">
                                    <label class="custom-control-label" for="switch_not{{$product->id}}"></label>
                                </div>
                                @endif
                        </div>
                </td>
                        ...
                        <div class="col-12 mb-2 text-lg-left text-md-right text-sm-right dropup">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <button class="dropdown-item" type="button" data-toggle="modal"
                                    data-target="#exampleModalCenter-edit-list">เพิ่มเติม</button>
                            </div>
                        </div>
                    </div>
                </td>
