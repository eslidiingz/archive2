                ...
                <div class="w-100">
                    <div class="tab-content">
                        ...
                        <div class="col-lg-12 col-md-12 col-12 py-4" style="background: #fff;">
                            <form role="search" action="/dashboard/orderCancelCustomer" method="GET">
                                {{-- @csrf --}}
                                ...
                                <div class="input-group flex-wrap pt-2 justify-content-center">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-12 mb-2">
                                        <a href="/dashboard/orderCancelCustomer"><input type="button" value="ล้างค่า" class="form-control btn " style="background-color: #ffc107"></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <table class="table table-striped" id="buy_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="text-align: center; align-items: center;">
                                                    ...
                                                    <td data-label="ยกเลิกโดย" style="font-weight:bold;">
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade modal_project"
                                                        id="chk_status{{ $cancelcase_all_value->id }}" role="dialog">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <p class="text-modal_header">รายละเอียดเคส</p>
                                                                ...
                                                                <form
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="d-flex flex-wrap">
                                                                            <div class="col-md-6 col-12 layout-detail-modal mb-4">
                                                                                <div class="d-flex flex-wrap">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        <b>ชื่อผู้ซื้อ :</b>
                                                                                        <b>{{ $cancelcase_all_value->user_name }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        <b>เบอร์ผู้ซื้อ :</b>
                                                                                        <b>{{ $cancelcase_all_value->user_phone }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        <b>ชื่อร้านค้า :</b>
                                                                                        <b>{{ $cancelcase_all_value->shop_name }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        <b>invs :</b>
                                                                                        <b>{{ $cancelcase_all_value->inv_ref }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        ...
                                                                                        <b>{{ number_format($cancelcase_all_value->total,2) }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        ...
                                                                                        <b>{{ number_format($cancelcase_all_value->shipping_cost,2) }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <div class="d-flex flex-wrap pt-2">
                                                                                    <div class="w-100 px-0 text-left">
                                                                                        <b>รวมราคา :</b>
                                                                                        <b>{{ number_format($cancelcase_all_value->sum_total,2) }}</b>
                                                                                    </div>
                                                                                    <!-- <div class="col-6 px-0 text-right">
                                                                                        <b>
                                                                                ...
                                                                                <!-- <div class="d-flex flex-wrap pt-2 mb-4">
                                                                                    <div
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="d-flex flex-wrap pt-2 mb-4">
                                                                                    <div
                                                                                        class="w-100 pb-2 px-0 text-left">
                                                                                        <b>บันทึกข้อความ admin : </b>
                                                                                    </div>
                                                                                    @if($cancelcase_all_value->status !=
                                                                                    '99'
                                                                            ...
                                                                            <div class="col-6 pl-0 text-right">
                                                                                <a href="#">
                                                                                    <button class="form-control mx-0"
                                                                                        type="submit"
                                                                                        style='color:white;background:#346751'>บันทึก</button>
                                                                                </a>
                                                                            </div>
    ...
    $(document).ready(function () {
        ...
        $('#aExportExcel').click(function() {
            if( location.search.substr(1) != '' ) {
                window.location.href = "/dashboard/invs_cancel_customer/excel?"+location.search.substr(1);
            } else {
                window.location.href = "/dashboard/invs_cancel_customer/excel";
            }
        });
    });
