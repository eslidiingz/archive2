...
function TopbarMenu() {
  ...
  const MENUS = [
    { id: "homepage", name: t("menu.NFTStamp"), pathname: "#Information",target: "" },
    {
      id: "BuyStammp",
      name: t("menu.OrderStamps"),
      pathname:
    ...
    { id: "CodeStamp", name: t("menu.Fill"), pathname: "#CodeStamp",target: "" },
    { id: "FAQ", name: t("menu.FAQ"), pathname: "#FAQ",target: "" },
    { id: "Register", name: t("menu.Registernav"), pathname: "/register",target: "" },
        ...
        <div className="container h-100">
          <div className="row h-100">
            <div className="col-lg-2 d-lg-flex d-none align-items-center justify-content-start">
              ...
              <p className="text-menuL">{t("menu.MenuNav")}</p>
            </div>
