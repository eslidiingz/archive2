...
<div class="row" style="padding-bottom: 50px;">
    <div class="col-12 px-1 pt-4 d-flex flex-row">
        <div class="col-lg-9 col-md-9 col-sm-6 col-xs-5">
            <h3><strong>ที่อยู่ ร้าน: {{$user_shops->shop_name}}</strong></h3>
            <p>ตั้งค่าที่อยู่ของร้านค้า</p>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-2" style='text-align : right;'>
            <button class="btn btn-outline-pink btn form-control mb-3" data-toggle="modal" data-target="#add_address">+ เพิ่มที่อยู่ในการจัดส่ง</button>
        </div>
    </div>
        ...
        <div class='row mx-0' style='background-color: white;padding-bottom : 20px;'>
            ...
            <div class='col-lg-2 col-md-2 col-12 pt-4 dropup' style='text-align : right'>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="/dashboard/manageUser/sellerAddress/delete/?id={{$add->id}}" class="dropdown-item" type="button">ลบ</a>
                    <a href="/dashboard/manageUser/setBackShopAddress/?id={{$add->id}}" class="dropdown-item" type="button">นำออก</a>
        ...
        <div class='row mx-0 modal_chk' style='background-color: white;padding-bottom : 20px;'>
            ...
            <div class='col-lg-2 col-md-2 col-12 pt-4 dropup' style='text-align : right'>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="/dashboard/manageUser/setShopAddress/?id={{$add->id}}" class="dropdown-item" type="button">ที่ตั้งร้านค้า</a>
...
<div class="modal fade" id="edit_address{{ $addModal->id }}" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('dashboard.edit.shopAddress') }}" method="POST" enctype="multipart/form-data" class="demo" id="demo1">
                @csrf
                        ...
                        <div class="col-12">
                            <div class='form-row'>
                                ...
                                <div class="col-6 mb-3 text-center">
                                    ...
                                    <button class="btn btn-save btn-outline-pink form-control text-white rounded8px" onclick="myFunction()" >บันทึก</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="add_address" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            @csrf
            <input type="hidden" value="{{$user_shops->user_id}}" name="user_id">
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <div class="form-row">
            ...
            <div class="col-12 ">
                <div class='form-row'>
                    ...
                    <div class="col-6 mb-3 text-center">
                        <button class="btn btn-outline-pink form-control text-white rounded8px submit_address" type="submit">บันทึก</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $('.submit_address').on('click',function(){
        ...
        $.ajax({
            url: '/dashboard/manageUser/shopAddress/new',
            type: 'POST',
            data: {
                user_id: user_id,
                name: name,
