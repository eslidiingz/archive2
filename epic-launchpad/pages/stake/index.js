      ...
      <main>
        <div className="container">
          <div className="py-5 my-5 flex-grow-1">
            <div className="content-paper-token p-3">
              <button
              ...
              <div className="card-table">
                <table className="mt-2 table color-brown">
                  <thead>
                    <tr>
                      <th>Token Stake (EPIC)</th>
                      <th>Est. APY</th>
                      <th>Start Date</th>
                    ...
                    {stake_list.map((item, index) => {
                      return (
                        <tr className="mt-4" key={index}>
                          <td data-label="TOKEN STAKE (EPIC)">
                            {numeral(formatEther(item.amounts)).format(
                              "0,0.00"
                            )}
                          </td>
                          <td data-label="EST. APY">
                            {formatUnits(item.roi, "wei") / 100}
                          </td>
                          ...
                          <td data-label="DURATION (MINUTES)">
                            {formatUnits(item.month, "wei") / 60}
                          </td>
                          ...
                          <td data-label="Rewards (EPIC)">
                            {numeral(formatEther(item.rewards)).format(
                              "0,0.00"
                            )}
                          </td>
                          <td>
      ...
      >
        <div className="flex ">
          ...
          <div className="d-flex justify-content-center">
            <ButtonState
              classStyle={"btn-action btn-custom mg-r-10"}
              text={"APPROVE BUSD"}
            ...
            <ButtonState
              classStyle={`btn-action btn-custom-stake`}
              text={"STAKE"}
