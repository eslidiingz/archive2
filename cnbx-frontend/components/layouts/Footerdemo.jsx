...
function Footerdemo() {
  const contantFooter = [
    ...
    {
      id: "3",
      tittle: "พิพิธภัณฑ์ตราไปรษณียากรสามเสนใน",
      tittle1:"",
      href1:"",
  ...
  const QuickMenuFooter = [
    {
      idQM: "9",
      tittleQM: "รู้จักแสตมป์",
      hrefQM: "#Information",
      target: ""
    },
    {
      idQM: "10",
      tittleQM: "สั่งซื้อ Stamp",
  ...
  return (
    <section className="footer">
        ...
        <div className="container">
          <div className="row d-flex align-items-center px-lg-0 px-4">
            <div className="col-lg-4">
              ...
              <p className="tittle-logo_footer">บริษัท ไปรษณีย์ไทย จำกัด</p>
              <p className="detail-logo_footer mb-3">111 ถนนแจ้งวัฒนะ แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพมหานคร 10210-0299</p>
            </div>
            <div className="col-lg-4 mb-4">
              <p className="text-topic_footer mt-3">ติดต่อสอบถาม</p>
              ...
              <div className="d-flex align-items-center">
                <div className="d-flex d-xl-none">
                  <i className="fas fa-arrow-alt-circle-right icon_footers"></i>
                  <p className="text-detail_footer_notchange">โทร :
                  <Link href={"tel:+1545"}><a className="ms-2 text-detail_footer">1545</a></Link>,
                  <Link href={"tel:+022712439"}><a className="ms-2 text-detail_footer">02-2271-2439</a></Link>
                  </p>
                </div>
            ...
            <div className="col-lg-4 mb-4">
            <p className="text-topic_footer mt-3">ติดต่อสอบถามเรื่อง NFT</p>
            ...
            <div className="row h-100 mt-lg-3 mt-4">
              ...
              <div className="col-xxl-1 col-lg-3 d-flex align-items-center justify-content-start">
                <p className="text-topic_footer mb-0">เมนูลัด</p>
              </div>
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="row">
            <div className="col-lg-10 col-12 mb-lg-0 mb-2 d-flex justify-content-center justify-content-lg-start text-center text-md-right">
